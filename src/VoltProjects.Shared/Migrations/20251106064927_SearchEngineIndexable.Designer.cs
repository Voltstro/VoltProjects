...
namespace VoltProjects.Shared.Migrations
{
    ...
    [Migration("20251106064927_SearchEngineIndexable")]
    partial class SearchEngineIndexable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("VoltProjects.Shared.Models.DocBuilder", b =>
                {
                    ...
                    b.PrimitiveCollection<string[]>("Arguments")
                        .HasColumnType("text[]")
                        .HasColumnName("arguments");

                    b.PrimitiveCollection<string[]>("EnvironmentVariables")
                        .HasColumnType("text[]")
            ...
            modelBuilder.Entity("VoltProjects.Shared.Models.ProjectVersion", b =>
                {
                    ...
                    b.Property<bool>("SeIndexable")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true)
                        .HasColumnName("se_indexable");
